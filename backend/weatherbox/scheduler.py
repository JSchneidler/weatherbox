...
from weatherbox.sensors.sps30 import read_and_store as sample_sps30
...
scheduler.add_job(sample_as7341, "interval", seconds=5)
scheduler.add_job(sample_bme688, "interval", seconds=5)
scheduler.add_job(sample_ens160, "interval", seconds=5)
scheduler.add_job(sample_ltr390, "interval", seconds=5)
# scheduler.add_job(sample_sps30, "interval", seconds=5)
